...
│   ├── ClaudeCode_Capstone*_HandsOnLab.html   # Capstone labs (main, B, C, D, E)
...
│   ├── ClaudeCode_Capstone*_HandsOnLab.html   # 캡스톤 랩 (main, B, C, D, E)
